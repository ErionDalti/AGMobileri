...
// App colors
const Color kPrimaryColor = Color(0xFF876709);
const Color kAccentColor = Color(0xFF262626);
...
const Color kActiveBackgroundColor = Color(0xFF876709);
...
const Color kRedTextColor = Color(0xFF19BF3F);
...
// API urls
//const String kDevBaseUrl = 'http://45.77.187.45/wooden-craft/';
const String kDevBaseUrl = 'https://agmobileri.deumsoft.com/';
...
const String kApiGetAttributesByProductId = kApiBaseUrl + 'getAttrsforProduct';
const String kApiGetVariantByProductId = kApiBaseUrl + 'getVariantByAttrs1';
